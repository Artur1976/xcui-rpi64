...
rDownloadURL = {"main": "https://bitbucket.org/xtreampi/xrpi/downloads/main_xtreamcodes_reborn_rpi64.tar.gz", "sub": "https://bitbucket.org/xtreampi/xrpi/downloads/sub_xtreamcodes_reborn_rpi64.tar.gz"}
rPackages = ["libcurl4", "libxslt1-dev", "libgeoip-dev", "e2fsprogs", "wget", "mcrypt", "nscd", "htop", "zip", "libx264-dev", " libx265-dev", "libxvidcore-dev", "libvorbis-dev", "libopus-dev", "libtheora-dev", "libvpx-dev", "libwebp-dev", "libfdk-aac-dev", "libmp3lame-dev", "unzip", "mc", "libpng16-16", "libzip-dev", "python-is-python2", "libonig-dev" , "mariadb-server"]
...
if __name__ == "__main__":
    printc("Install XCRPI64 ", col.OKGREEN, 2)
